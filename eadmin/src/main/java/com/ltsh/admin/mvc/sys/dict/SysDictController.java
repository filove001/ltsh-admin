...
public class SysDictController extends BaseController {
	...
	public String edit(HttpServletRequest request,HttpServletResponse response,SysDict sysDict) {
		...
		//控制编辑框是否不可见
	   	request.setAttribute("idDisplayNone", true);
	   	request.setAttribute("dictValueDisplayNone", true);
	   	request.setAttribute("dictKeyDisplayNone", true);
	   ...
	   //控制编辑框是否不可用
	   	...
	   	request.setAttribute("dictValueDisabled", true);
	   	request.setAttribute("dictKeyDisabled", true);
