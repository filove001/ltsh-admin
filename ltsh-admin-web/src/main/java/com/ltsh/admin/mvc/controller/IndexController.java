...
import com.ltsh.admin.security.shiro.ShiroSecuritys;
...
public class IndexController extends BaseController {
	...
	public String login(HttpServletRequest request,HttpServletResponse response) {
		//判断是否登录登录后不要在登录页
		if(ShiroSecuritys.getCurrentUser()!=null){
	...
	public String layout(HttpServletRequest request,HttpServletResponse response) {
		request.setAttribute("me", ShiroSecuritys.getCurrentUser());
		request.setAttribute("sysMenuBos", ShiroSecuritys.getSysMenuBos());
		return index;
	}
}
